...
{
  InetAddress addr0(AF_INET, 1234);
  ...
  InetAddress addr1(AF_INET, 4321, true);
  ...
  InetAddress addr2(AF_INET, "1.2.3.4", 8888);
  ...
  InetAddress addr3(AF_INET, "255.254.253.252", 65535);
